...
While SitecoreDXG generates documentation for you, what do you do with the documentation once generation has completed is entirely up to you. SitecoreDXG supports the execution of one or more completion handlers after successful generation, and ships with an example completion handler, _helloWorld_, and four practical completion handlers - the [AWS S3 Deploy](../getting-started/using-sitecoredxg/using-the-provided-aws-s3-deploy-completion-handler.md)_,_ [Azure Blob Storage Deploy](../getting-started/using-sitecoredxg/using-the-provided-azure-blob-storage-deploy-completion-handler.md), [Slack Notification](slack-and-ms-teams-integration/integrating-with-slack-via-webhooks.md), and [Microsoft Teams Notification](slack-and-ms-teams-integration/integrating-with-ms-teams-via-webhooks.md) - to help you to create custom handlers of your own.
