...
* [Installing SitecoreDXG](getting-started/installing-sitecoredxg/README.md)
  ...
  * [Developer Installation](getting-started/installing-sitecoredxg/advanced-installation/README.md)
    ...
    * [4. \(Optional\) Configure the Documentation Configuration Item for your Solution](getting-started/installing-sitecoredxg/advanced-installation/4.-optional-configure-the-documentation-configuration-item-for-your-solution.md)
    * [5. \(Optional\) Install the Default RabbitMQ Middleman for Developers](getting-started/installing-sitecoredxg/advanced-installation/optional-install-the-default-rabbitmq-middleman-for-developers.md)
    * [6. \(Optional\) Integrate SitecoreDXG into your CI/CD Pipeline for Developers](getting-started/installing-sitecoredxg/advanced-installation/6.-optional-integrate-sitecoredxg-into-your-ci-cd-pipeline-for-developers.md)
...
* [CI/CD Integration](how-to/cicd/README.md)
  * [Integrating SitecoreDXG into your CI/CD Pipeline](how-to/cicd/integrating-sitecoredxg-into-your-ci-cd-pipeline.md)
